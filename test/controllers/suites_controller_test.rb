...
class SuitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suite" do
    assert_difference("Suite.count") do
      post suites_url, params: { suite: { description: @suite.description, title: @suite.title } }
    end
  ...
  test "should update suite" do
    patch suite_url(@suite), params: { suite: { description: @suite.description, title: @suite.title } }
